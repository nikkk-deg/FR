...
var _millisecondsToHours = require("date-fns/millisecondsToHours");
var _millisecondsToHoursDefault = parcelHelpers.interopDefault(_millisecondsToHours);
const getTimeFromDate = (date)=>new Date(date).getTime() - new Date().getTime();
const getHoursFromTime = (time)=>(0, _millisecondsToHoursDefault.default)(time) + new Date().getTimezoneOffset() / 60;
const getTimeArr = (hours)=>{
    let timeArr = [];
    timeArr.push(Math.floor(hours / 8760));
    timeArr.push(Math.floor((hours - timeArr[0] * 8760) / 24));
    timeArr.push(hours - timeArr[0] * 8760 - timeArr[1] * 24);
    return timeArr;
};
const changeTimeTxt = (arr)=>{
    (0, _viewJs.changeTxtYear)(arr[0]);
    (0, _viewJs.changeTxtDays)(arr[1]);
    (0, _viewJs.changeTxtHours)(arr[2]);
};
const changeUI = (arr)=>{
    (0, _viewJs.UI_EL).YEARS.textContent = arr[0];
    (0, _viewJs.UI_EL).DAYS.textContent = arr[1];
...
parcelHelpers.export(exports, "UI_EL", ()=>UI_EL);
parcelHelpers.export(exports, "changeTxtYear", ()=>changeTxtYear);
parcelHelpers.export(exports, "changeTxtDays", ()=>changeTxtDays);
parcelHelpers.export(exports, "changeTxtHours", ()=>changeTxtHours);
const UI_EL = {
...
const changeTxtYear = (years)=>{
    if (years > 20) years %= 10;
    switch(years){
        case 1:
...
},{}],"2GgQk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/requiredArgs/index.js":"9wUgQ","../constants/index.js":"iOhcx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9wUgQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lmKb7","adjPd"], "adjPd", "parcelRequire94c2")
